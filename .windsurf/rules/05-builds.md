...
description: Aplicado na manutenção do arquivo package.json na raiz do projeto, independente da linguagem, deve haver este arquivo para orquestração de scripts, em conjunto por exemplo com cmake.
>>>>>>> main
---
